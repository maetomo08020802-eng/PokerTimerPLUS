/**
 * v2.0.14 静的解析テスト — audit 結果中重要度 7 項目 + B-6 一括修正
...
// ============================================================
// T11: package.json version 2.0.14 + scripts.test に v214 登録
// ============================================================
test('T11: package.json version 2.0.14 + scripts.test に v214 登録', () => {
  assert.equal(PKG.version, '2.0.14', `version が ${PKG.version}（期待 2.0.14）`);
