/**
 * v2.1.20-rc4 静的解析テスト — operator 側 preStartState 受信機構追加
 *
...
// ============================================================
test('T1: package.json.version === 2.1.20-rc4', () => {
  assert.equal(PKG.version, '2.1.20-rc4', `期待 2.1.20-rc4, 実際 ${PKG.version}`);
});
