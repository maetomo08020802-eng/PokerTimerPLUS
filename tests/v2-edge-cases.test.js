...
// ============================================================
// T6: _dualStateCache のキーが 11 種類で固定されている（仕様の明示）
//   v2.0.4-rc10 Fix 1-A で specialStack 追加（9 → 10）。Ctrl+E の hall 反映に必要。
//   v2.1.6 で preStartState 追加（10 → 11）。PRE_START の hall 同期に必要。
// ============================================================
test('T6: _dualStateCache のキーが期待の 11 種類のみ', () => {
  ...
  const expectedKeys = [
    ...
    'preStartState' // v2.1.6 (PRE_START の hall 同期、案 2 専用 broadcast kind)
  ];
