/**
 * v2.1.20-rc6-meas3 静的解析テスト — 観測機構強化（HDMI 自動採取 + 高頻度集約 + buffer 拡張 + priority buffer）
 *
...
// ============================================================
test('T1: package.json.version === 2.1.20-rc6-meas3', () => {
  assert.equal(PKG.version, '2.1.20-rc6-meas3', `期待 2.1.20-rc6-meas3, 実際 ${PKG.version}`);
});
