...
| ファイル | 用途 | 出典 | ライセンス | 表記 |
| --- | --- | --- | --- | --- |
| shuffle-up-and-deal-female-1.mp3 〜 -4.mp3 | 開始ボイス（女性 1〜4） | ⚠️ 要・前原確認 | ⚠️ 確認中 | ⚠️ 確認中 |
| shuffle-up-and-deal-male-clear-1.mp3 〜 -4.mp3 | 開始ボイス（男性 1〜4） | ⚠️ 要・前原確認 | ⚠️ 確認中 | ⚠️ 確認中 |

> ⚠️ **配信前に確定必須**: 上記 8 ファイルの出典・ライセンス・表記要否は前原確認待ち（CC は推測でライセンスを記載しない）。配信（v2.6.4）GO の前に確定値へ差し替える。効果音ラボ提供であれば上表と同条件（商用無料・表記任意・同梱可）。
