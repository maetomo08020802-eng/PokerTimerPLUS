...
- **③ 前原が「クリアします」と言ったら(2026-07-07 常設・全プロジェクト同一)**: 長文のチャット引継ぎ文を書かない・別話題の回答や新規提案をしない。やることは1つだけ=PROGRESS.md が最新か確認し、未反映(進行中の中断地点/完了の移し忘れ)があれば「直近の状態」を更新して push→「クリアOK(PROGRESS 最新化済)」と短く返す。
