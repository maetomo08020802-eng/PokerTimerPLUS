...
| オープン作業 | 2 件（**v2.6.0 fee-pot-yen：配信 GO 待ち** / **v2.6.0 perf-heaviness：6-B 待ち**、いずれも同一 v2.6.0 配信に同梱）|
| 最新テスト件数 | **1341 件 全 PASS**(perf-heaviness +13[v265]、v204-rc9 期待値更新で件数不変)|
