...
| v2.6.0（想定） | fee-pot-yen 実装（店内通貨$・1件あたり拠出モデル／%全廃） | 🟡 STEP1〜4（実装）全完了・1328件全PASS／STEP5（doc+version bump+テストビルド）= 前原 GO 待ち | `.cc-briefs/2026-06-07_fee-pot-yen_impl_brief.md` | `.cc-plans/2026-06-07_fee-pot-yen_plan.md` | `.cc-reports/2026-06-07_fee-pot-yen_step4.md` |
